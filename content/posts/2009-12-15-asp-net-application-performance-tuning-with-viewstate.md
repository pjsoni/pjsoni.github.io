...
date: 2009-12-15
slug: asp-net-application-performance-tuning-with-viewstate 
summary: "A practical look at ASP.NET ViewState and how excessive ViewState data can negatively affect page performance. The post explores compressing ViewState data to reduce page size and improve load times, including the implementation used to compress the serialized ViewState payload."
category: ASP.NET
tags:
  - performance
  - view state
