...
date: 2010-01-25
slug: how-to-show-thumbnails-of-xps-documents
summary: "A practical approach to generating thumbnails for XPS documents in a SharePoint document library without relying on a third-party component. The post explores the native .NET Framework APIs available through ReachFramework.dll and introduces an XpsThumbnail class for generating image previews from XPS files."
---
